  ...
  return (
    <div>
      ...
      {resultImagePath !== null ? (
        <>
          <h3>Result Image</h3>
          <img src={`http://127.0.0.1:5000/get_result_image`} alt="Result" />
      ...
      {inputImagePath !== null ? (
        <>
          <h3>Input Image</h3>
          <img src={`http://127.0.0.1:5000/get_input_image`} alt="Input" />
      ...
      {matchingImagePath !== null ? (
        <>
          ...
          <img src={`http://127.0.0.1:5000/get_matching_image`} alt="Matching" />
          {console.log(referencedImagePath)}
        </>
      ) : (
        <></>
