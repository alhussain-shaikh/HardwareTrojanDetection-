...
int main()
{
    ...
    cout << "Contents of gate_type are : ";
    for (int i = 0; i < V; i++)
    {
        cout << gate_type[i] << " ";
    }
    ...
    cout << "Contents of gate_type_tmp are : ";
    for (int i = 0; i < gate_type_tmp.size(); i++)
    {
        for (int j = 0; j < gate_type_tmp[i].size(); j++)
        {
            cout << gate_type_tmp[i][j] << " ";
        }
        cout << endl;
    }
    cout << endl;
    ...
    for (int j = 0; j < 2; j++)
    {
        for (int i = 0; i < edge; i++)
        {
            ...
            cout << "Size of tc is : " << tc.size();
            cout << " falut_net is : " << fault_net;
            cout << endl;

            cout << "if condition variable : " << gate_type[gatedata[fault_net][0]] << endl;
            ...
            else
            {
                ...
                std::ofstream outputFile("testcases.txt", std::ios::app); // Open in append mode
                if (outputFile.is_open())
                {
                    outputFile << "Test Vector"
                               << ": ";
                    for (int i = 0; i < num_in; i++)
                    {
                        if (tc[tc.size() - 1][i] == 'D')
                        ...
                        {
                            outputFile << tc[tc.size() - 1][i] << " ";
                        }
                    }
                    outputFile << std::endl;

                    outputFile << "PATH (EdgeNumber-[GateNumber]): ";
                    for (int i = 0; i < tc[tc.size() - 1].size(); i++)
                    {
                        if (tc[tc.size() - 1][i] == 'D' || tc[tc.size() - 1][i] == 'E')
                        {
                            outputFile << i + 20 << "-[" << gatedata[i][1] << "]-";
                        }
                    }
                ...
                {
                    std::cerr << "Unable to open file testcases.txt" << std::endl;
                }
            }
