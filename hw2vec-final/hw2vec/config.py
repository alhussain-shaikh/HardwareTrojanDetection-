...
class Config:
    def __init__(self, args):
        ...
        ap.add_argument('--yaml_path', type=str, default="examples/example_gnn4tj.yaml", help="The path of yaml config file.")
        ap.add_argument('--raw_dataset_path', type=str, default="../assets/datasets/TJ-RTL-toy/", help="The path to raw dataset for parsing.")
        ap.add_argument('--data_pkl_path', type=str, default="../assets/pretrained_DFG_TJ_RTL/DFG-TJ-RTL.pkl", help="The path to the pickle file storing the graph dataset.")
        ...
        args_parsed, unknown = ap.parse_known_args()
